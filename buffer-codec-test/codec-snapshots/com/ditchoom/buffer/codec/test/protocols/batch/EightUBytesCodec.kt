...
public object EightUBytesCodec : Codec<EightUBytes> {
  override fun decode(buffer: ReadBuffer, context: DecodeContext): EightUBytes {
    ...
    if (buffer.byteOrder == ByteOrder.BIG_ENDIAN) {
      a = (__batch20 ushr 56 and 0xFFL).toUByte()
      b = (__batch20 ushr 48 and 0xFFL).toUByte()
      c = (__batch20 ushr 40 and 0xFFL).toUByte()
      d = (__batch20 ushr 32 and 0xFFL).toUByte()
      e = (__batch20 ushr 24 and 0xFFL).toUByte()
      f = (__batch20 ushr 16 and 0xFFL).toUByte()
      g = (__batch20 ushr 8 and 0xFFL).toUByte()
      h = (__batch20 and 0xFFL).toUByte()
    } else {
      a = (__batch20 and 0xFFL).toUByte()
      b = (__batch20 ushr 8 and 0xFFL).toUByte()
      c = (__batch20 ushr 16 and 0xFFL).toUByte()
      d = (__batch20 ushr 24 and 0xFFL).toUByte()
      e = (__batch20 ushr 32 and 0xFFL).toUByte()
      f = (__batch20 ushr 40 and 0xFFL).toUByte()
      g = (__batch20 ushr 48 and 0xFFL).toUByte()
      h = (__batch20 ushr 56 and 0xFFL).toUByte()
    }
