...
public object MqttTopicFilterCodec : Codec<MqttTopicFilter> {
  override fun decode(buffer: ReadBuffer, context: DecodeContext): MqttTopicFilter {
    ...
    val filter = buffer.readText(filterLength, (context[TextPolicyKey] ?: DEFAULT_TEXT_POLICY))
  ...
  override fun encode(
    ...
    buffer.writeText(value.filter, (context[TextPolicyKey] ?: DEFAULT_TEXT_POLICY))
