...
public object LittleWirePacketCodec : Codec<LittleWirePacket> {
  override fun decode(buffer: ReadBuffer, context: DecodeContext): LittleWirePacket {
    ...
    val byte = (__batch1 and 0xFF).toByte()
    val ubyte = (__batch1 ushr 8 and 0xFF).toUByte()
    val short = (__batch1 ushr 16 and 0xFFFF).toShort()
    ...
    val int = (__batch2 and 0xFFFFFFFFL).toInt()
    val uint = (__batch2 ushr 32 and 0xFFFFFFFFL).toUInt()
