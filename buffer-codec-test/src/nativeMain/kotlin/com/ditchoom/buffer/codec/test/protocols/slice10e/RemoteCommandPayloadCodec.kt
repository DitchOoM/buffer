...
/**
 * Native `actual` — covers all native targets (`macosArm64`,
 * `macosX64`, `linuxX64`) via the `applyDefaultHierarchyTemplate`
 * intermediate `nativeMain` source set. Delegates to the shared
 * impl. See JVM peer for rationale.
 */
