 ...
 */
internal class SafeBufferPoolImpl(
    initialPoolSize: Int,
    ...
    override fun release(buffer: PooledBuffer) {
        ...
        synchronized(pool) {
            ...
            // If pool is full, buffer is discarded and will be GC'd
        }
    }
...
private class SafePooledBuffer(
    val inner: PlatformBuffer,
    private val pool: SafeBufferPoolImpl,
) : PooledBuffer {
    ...
    override fun readString(length: Int, charset: Charset): String = inner.readString(length, charset)
    ...
    override fun writeByte(byte: Byte): WriteBuffer { inner.writeByte(byte); return this }
    override fun set(index: Int, byte: Byte): WriteBuffer { inner.set(index, byte); return this }
    override fun writeBytes(bytes: ByteArray, offset: Int, length: Int): WriteBuffer {
        inner.writeBytes(bytes, offset, length)
        return this
    }
    override fun writeShort(short: Short): WriteBuffer { inner.writeShort(short); return this }
    override fun set(index: Int, short: Short): WriteBuffer { inner.set(index, short); return this }
    override fun writeInt(int: Int): WriteBuffer { inner.writeInt(int); return this }
    override fun set(index: Int, int: Int): WriteBuffer { inner.set(index, int); return this }
    override fun writeLong(long: Long): WriteBuffer { inner.writeLong(long); return this }
    override fun set(index: Int, long: Long): WriteBuffer { inner.set(index, long); return this }
    override fun writeFloat(float: Float): WriteBuffer { inner.writeFloat(float); return this }
    override fun set(index: Int, float: Float): WriteBuffer { inner.set(index, float); return this }
    override fun writeDouble(double: Double): WriteBuffer { inner.writeDouble(double); return this }
    override fun set(index: Int, double: Double): WriteBuffer { inner.set(index, double); return this }
