...
/**
 * Benchmarks for `ReadBuffer.readText` (vs [ReadStringBenchmark] as baseline) —
 * the UTF-8 -> UTF-16 decode hot path on the
...
open class ReadTextBenchmark {
    ...
    private fun read(source: Source): String {
        ...
        return source.buffer.readText(source.byteLength, Utf8.Lenient)
    }
