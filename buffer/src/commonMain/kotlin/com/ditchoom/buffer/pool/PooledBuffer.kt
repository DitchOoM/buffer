...
internal class PooledBuffer(
     ...
     * plain counter and is unchanged. `MultiThreaded` pools — the ones a shared, cross-thread
     * buffer must come from, as `SharedBytes.adopt` already enforces — pay for the safety they
     * actually need.
     */
