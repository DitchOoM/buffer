...
fun WriteBuffer.writeLengthPrefixedUtf8String(string: String): WriteBuffer {
    ...
    val stringLength = position() - startStringPosition
    require(stringLength <= UShort.MAX_VALUE.toInt()) {
        "String UTF-8 byte length $stringLength exceeds maximum length-prefixed size of ${UShort.MAX_VALUE}"
    }
    set(sizePosition, stringLength.toUShort())
    return this
}
