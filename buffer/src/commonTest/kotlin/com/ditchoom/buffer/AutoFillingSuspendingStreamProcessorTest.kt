...
class AutoFillingSuspendingStreamProcessorTest {
    @Test
    fun autoFillsOnReadByte() = runTest {
        withPool { pool ->
    ...
    @Test
    fun autoFillsOnPeekByte() = runTest {
        withPool { pool ->
    ...
    @Test
    fun autoFillsAcrossMultipleChunks() = runTest {
        withPool { pool ->
    ...
    @Test
    fun readBufferAutoFills() = runTest {
        withPool { pool ->
    ...
    @Test
    fun throwsEndOfStreamWhenExhausted() = runTest {
        withPool { pool ->
    ...
    @Test
    fun peekShortAutoFills() = runTest {
        withPool { pool ->
    ...
    @Test
    fun peekMatchesAutoFills() = runTest {
        withPool { pool ->
    ...
    @Test
    fun multipleRefillsForLargeRead() = runTest {
        withPool { pool ->
    ...
    @Test
    fun appendDirectlyStillWorks() = runTest {
        withPool { pool ->
    ...
    private fun buildAutoFilling(
        ...
        return StreamProcessor.builder(pool)
    ...
    private fun makeChunks(vararg arrays: ByteArray): List<ReadBuffer> =
        arrays.map { makeBuffer(it) }
