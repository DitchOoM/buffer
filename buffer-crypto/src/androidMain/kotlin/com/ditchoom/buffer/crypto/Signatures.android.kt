...
/**
 * Ed25519 is reported **unsupported** on Android — the witness resolves to
 * [SignatureSupport.Unavailable], so no Ed25519 op is reachable — matching the Apple-vs-keystore
 * reality. Although Android 14 (API 34+) advertises Ed25519, the platform exposes it **only**
